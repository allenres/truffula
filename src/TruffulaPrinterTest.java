...
public class TruffulaPrinterTest {
    ...
    @Test
    public void testPrintTree_ShowHiddenFile(@TempDir File tempDir) throws IOException {
        // Create "myFolder"
        File myFolder = new File(tempDir, "myFolder");
        assertTrue(myFolder.mkdir(), "myFolder should be created");
        ...
        File readme = new File(documents, "README.md");
        File notes = new File(documents, "notes.txt");
        createHiddenFile(documents, ".notes2.txt");
        readme.createNewFile();
        notes.createNewFile();
        ...
        expected.append(white).append("   banana.txt").append(nl).append(reset);
        expected.append(white).append("   Documents/").append(nl).append(reset);
        expected.append(white).append("      .notes2.txt").append(nl).append(reset);
        expected.append(white).append("      images/").append(nl).append(reset);
        expected.append(white).append("         cat.png").append(nl).append(reset);
        expected.append(white).append("         Dog.png").append(nl).append(reset);
        expected.append(white).append("      notes.txt").append(nl).append(reset);
    ...
    @Test
    public void testPrintTree_ShowHiddenFalse(@TempDir File tempDir) throws IOException {
        // Create "myFolder"
        File myFolder = new File(tempDir, "myFolder");
        assertTrue(myFolder.mkdir(), "myFolder should be created");
    ...
    @Test
    public void testPrintTree_FileOnly(@TempDir File tempDir) throws IOException {
        // Build the example directory structure:
        // Apple.txt
        ...
        // Set up TruffulaOptions with showHidden = false and useColor = true
        TruffulaOptions options = new TruffulaOptions(apple, false, true);
